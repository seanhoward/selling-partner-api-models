...
namespace Amazon.SellingPartnerAPIAA.Clients.Schemas.Reports.VendorRealTimeTraffic
{
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "11.1.0.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class VendorRealTimeTrafficReport
    {
        /// <summary>
        ...
        public static VendorRealTimeTrafficReport FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<VendorRealTimeTrafficReport>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public enum ReportSpecificationReportType
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"GET_VENDOR_REAL_TIME_TRAFFIC_REPORT")]
        GET_VENDOR_REAL_TIME_TRAFFIC_REPORT = 0,
