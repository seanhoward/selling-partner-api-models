...
namespace Amazon.SellingPartnerAPIAA.Clients.Schemas.Reports.B2bProductOpportunitiesNotYetOnAmazon20201119
{
    ...
    public partial class B2bProductOpportunitiesNotYetOnAmazonReport20201119
    {
        /// <summary>
        ...
        public static B2bProductOpportunitiesNotYetOnAmazonReport20201119 FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<B2bProductOpportunitiesNotYetOnAmazonReport20201119>(data, new Newtonsoft.Json.JsonSerializerSettings());
