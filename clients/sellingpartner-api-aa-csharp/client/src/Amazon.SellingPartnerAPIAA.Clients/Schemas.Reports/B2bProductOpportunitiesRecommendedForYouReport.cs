...
namespace Amazon.SellingPartnerAPIAA.Clients.Schemas.Reports.B2bProductOpportunitiesRecommendedForYou
{
    ...
    public partial class B2bProductOpportunitiesRecommendedForYouReport
    {
        /// <summary>
        ...
        public static B2bProductOpportunitiesRecommendedForYouReport FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<B2bProductOpportunitiesRecommendedForYouReport>(data, new Newtonsoft.Json.JsonSerializerSettings());
