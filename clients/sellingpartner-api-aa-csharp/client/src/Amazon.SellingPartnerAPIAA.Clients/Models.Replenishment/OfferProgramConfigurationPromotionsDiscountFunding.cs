...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Replenishment
{
    ...
    public partial class OfferProgramConfigurationPromotionsDiscountFunding :  IEquatable<OfferProgramConfigurationPromotionsDiscountFunding>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OfferProgramConfigurationPromotionsDiscountFunding);
        }

        /// <summary>
        /// Returns true if OfferProgramConfigurationPromotionsDiscountFunding instances are equal
        /// </summary>
        /// <param name="input">Instance of OfferProgramConfigurationPromotionsDiscountFunding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferProgramConfigurationPromotionsDiscountFunding input)
        {
            if (input == null)
                return false;
