...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Replenishment
{
    ...
    /// </summary>
    [DataContract]
    public partial class OfferProgramConfigurationPromotions : IEquatable<OfferProgramConfigurationPromotions>, IValidatableObject
    {
        /// <summary>
        ...
        public OfferProgramConfigurationPromotions(OfferProgramConfigurationPromotionsDiscountFunding sellingPartnerFundedBaseDiscount = default, OfferProgramConfigurationPromotionsDiscountFunding sellingPartnerFundedTieredDiscount = default, OfferProgramConfigurationPromotionsDiscountFunding amazonFundedBaseDiscount = default, OfferProgramConfigurationPromotionsDiscountFunding amazonFundedTieredDiscount = default)
        {
        ...
        {
            return this.Equals(input as OfferProgramConfigurationPromotions);
        }

        /// <summary>
        /// Returns true if OfferProgramConfigurationPromotions instances are equal
        /// </summary>
        /// <param name="input">Instance of OfferProgramConfigurationPromotions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferProgramConfigurationPromotions input)
        {
            if (input == null)
                return false;
