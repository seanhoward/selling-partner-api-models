...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.FulfillmentOutbound
{
    ...
    public partial class GetDeliveryOffersResponse :  IEquatable<GetDeliveryOffersResponse>, IValidatableObject
    {
        ...
        public GetDeliveryOffersResponse(GetDeliveryOffersResult payload = default(GetDeliveryOffersResult), ErrorList errors = default(ErrorList))
        {
        ...
        {
            return this.Equals(input as GetDeliveryOffersResponse);
        }

        /// <summary>
        /// Returns true if GetDeliveryOffersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDeliveryOffersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDeliveryOffersResponse input)
        {
            if (input == null)
                return false;
