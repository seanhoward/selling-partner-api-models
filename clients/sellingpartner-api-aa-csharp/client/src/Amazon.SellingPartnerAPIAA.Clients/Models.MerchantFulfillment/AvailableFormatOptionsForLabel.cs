...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.MerchantFulfillment
{
    ...
    /// </summary>
    [DataContract]
    public partial class AvailableFormatOptionsForLabel : List<LabelFormatOption>,  IEquatable<AvailableFormatOptionsForLabel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailableFormatOptionsForLabel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AvailableFormatOptionsForLabel() : base()
        {
        }
