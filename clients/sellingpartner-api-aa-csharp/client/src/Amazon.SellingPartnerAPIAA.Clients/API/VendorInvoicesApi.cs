...
namespace Amazon.SellingPartnerAPIAA.Clients.API
{
    ...
    /// </summary>
    public interface IVendorInvoicesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VendorInvoicesApi : IVendorInvoicesApi
    {
        private Amazon.SellingPartnerAPIAA.Clients.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VendorInvoicesApi"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public VendorInvoicesApi(Amazon.SellingPartnerAPIAA.Clients.Client.Configuration configuration)
        {
        ...
        /// <summary>
        /// submitInvoices Submit new invoices to Amazon.  **Usage Plan:**  | Rate (requests per second) | Burst | | - -- - | - -- - | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
        /// </summary>
        /// <exception cref="Amazon.SellingPartnerAPIAA.Clients.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">The request body containing the invoice data to submit.</param>
        /// <returns>SubmitInvoicesResponse</returns>
        ...
        public ApiResponse< SubmitInvoicesResponse > SubmitInvoicesWithHttpInfo (SubmitInvoicesRequest body)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling VendorInvoicesApi->SubmitInvoices");
        ...
        public class Builder
        {
            ...
            public VendorInvoicesApi Build() 
            {
                ...
                return new VendorInvoicesApi(configuration);
            }
        }
    }
}
