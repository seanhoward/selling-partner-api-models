    ...
    public partial class AutomotiveApi : IAutomotiveApi
    {
        ...
        public ApiResponse<VehiclesResponse> GetVehiclesWithHttpInfo(string marketplaceId, string vehicleType, string pageToken = null, string updatedAfter = null)
        {
            ...
            if (marketplaceId == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceId' when calling AutomotiveApi->GetVehicles");
            // verify the required parameter 'vehicleType' is set
            if (vehicleType == null)
                throw new ApiException(400, "Missing required parameter 'vehicleType' when calling AutomotiveApi->GetVehicles");
