...
namespace Amazon.SellingPartnerAPIAA.Clients.API
{
    ...
    /// </summary>
    public interface IVendorShipmentsApi : IApiAccessor
    {
        ...
        /// <exception cref="Amazon.SellingPartnerAPIAA.Clients.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="limit">The limit to the number of records returned. Default value is 50 records. (optional)</param>
        /// <param name="sortOrder">Sort in ascending or descending order by transport label creation date. (optional)</param>
        /// <param name="nextToken">Used for pagination when there are more transport label than the specified result size limit. (optional)</param>
        /// <param name="labelCreatedAfter">transport Labels that became available after this timestamp will be included in the result. Must be in ISO-8601 date/time format. (optional)</param>
        /// <param name="labelcreatedBefore">transport Labels that became available before this timestamp will be included in the result. Must be in ISO-8601 date/time format. (optional)</param>
        /// <param name="buyerReferenceNumber">Get transport labels by passing Buyer Reference Number to retreive the corresponding transport label. (optional)</param>
        /// <param name="vendorShipmentIdentifier">Get transport labels by passing Vendor Shipment ID to retreive the corresponding transport label. (optional)</param>
        /// <param name="sellerWarehouseCode">Get Shipping labels based Vendor Warehouse code. This value should be same as &#39;shipFromParty.partyId&#39; in the Shipment. (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VendorShipmentsApi : IVendorShipmentsApi
    {
        private Amazon.SellingPartnerAPIAA.Clients.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VendorShipmentsApi"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public VendorShipmentsApi(Amazon.SellingPartnerAPIAA.Clients.Client.Configuration configuration)
        {
        ...
        /// <summary>
        /// GetShipmentLabels Returns transport Labels based on the filters that you specify.  **Usage Plan:**  | Rate (requests per second) | Burst | | - -- - | - -- - | | 10 | 10 |  The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were applied to the requested operation, when available. The table above indicates the default rate and burst values for this operation. Selling partners whose business demands require higher throughput may see higher rate and burst values than those shown here. For more information, see [Usage Plans and Rate Limits in the Selling Partner API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
        /// </summary>
        /// <exception cref="Amazon.SellingPartnerAPIAA.Clients.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="limit">The limit to the number of records returned. Default value is 50 records. (optional)</param>
        /// <param name="sortOrder">Sort in ascending or descending order by transport label creation date. (optional)</param>
        ...
        public ApiResponse< SubmitShipmentConfirmationsResponse > SubmitShipmentConfirmationsWithHttpInfo (SubmitShipmentConfirmationsRequest body)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling VendorShipmentsApi->SubmitShipmentConfirmations");
        ...
        public ApiResponse< SubmitShipmentConfirmationsResponse > SubmitShipmentsWithHttpInfo (SubmitShipments body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling VendorShipmentsApi->SubmitShipments");
        ...
        public class Builder
        {
            ...
            public VendorShipmentsApi Build() 
            {
                ...
                return new VendorShipmentsApi(configuration);
            }
        }
    }
}
