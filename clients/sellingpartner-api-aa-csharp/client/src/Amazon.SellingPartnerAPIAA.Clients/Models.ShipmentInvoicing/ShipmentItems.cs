...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.ShipmentInvoicing
{
    ...
    public partial class ShipmentItems : List<ShipmentItem>,  IEquatable<ShipmentItems>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ShipmentItems);
        }

        /// <summary>
        /// Returns true if ShipmentItems instances are equal
        /// </summary>
        /// <param name="input">Instance of ShipmentItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShipmentItems input)
        {
            if (input == null)
                return false;
