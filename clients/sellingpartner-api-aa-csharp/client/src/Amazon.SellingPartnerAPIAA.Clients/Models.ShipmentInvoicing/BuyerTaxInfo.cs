...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.ShipmentInvoicing
{
    ...
    public partial class BuyerTaxInfo :  IEquatable<BuyerTaxInfo>, IValidatableObject
    {
        ...
        public BuyerTaxInfo(string companyLegalName = default(string), string taxingRegion = default(string), TaxClassificationList taxClassifications = default(TaxClassificationList))
        {
