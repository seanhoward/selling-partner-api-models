...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.ProductPricing
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetFeaturedOfferExpectedPriceBatchRequest :  IEquatable<GetFeaturedOfferExpectedPriceBatchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public FeaturedOfferExpectedPriceRequestList Requests { get; set; }
        ...
        {
            return this.Equals(input as GetFeaturedOfferExpectedPriceBatchRequest);
        }

        /// <summary>
        /// Returns true if GetFeaturedOfferExpectedPriceBatchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFeaturedOfferExpectedPriceBatchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFeaturedOfferExpectedPriceBatchRequest input)
        {
            if (input == null)
                return false;
