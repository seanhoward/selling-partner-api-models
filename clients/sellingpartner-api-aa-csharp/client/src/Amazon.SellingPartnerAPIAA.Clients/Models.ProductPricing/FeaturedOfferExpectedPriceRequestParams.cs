...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.ProductPricing
{
    ...
    public partial class FeaturedOfferExpectedPriceRequestParams : IEquatable<FeaturedOfferExpectedPriceRequestParams>, IValidatableObject
    {
        ...
        public FeaturedOfferExpectedPriceRequestParams(string marketplaceId = default, string sku = default, Segment segment = default)
        {
            ...
            {
                throw new InvalidDataException("marketplaceId is a required property for FeaturedOfferExpectedPriceRequestParams and cannot be null");
            }
            else
            {
            ...
            if (sku == null)
            {
                throw new InvalidDataException("sku is a required property for FeaturedOfferExpectedPriceRequestParams and cannot be null");
            }
            else
            {
                this.Sku = sku;
        ...
        {
            return this.Equals(input as FeaturedOfferExpectedPriceRequestParams);
        }

        /// <summary>
        /// Returns true if FeaturedOfferExpectedPriceRequestParams instances are equal
        /// </summary>
        /// <param name="input">Instance of FeaturedOfferExpectedPriceRequestParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeaturedOfferExpectedPriceRequestParams input)
        {
            if (input == null)
                return false;
