...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.ProductPricing
{
    ...
    public partial class CompetitiveSummaryResponseList : List<CompetitiveSummaryResponse>,  IEquatable<CompetitiveSummaryResponseList>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CompetitiveSummaryResponseList);
        }

        /// <summary>
        /// Returns true if CompetitiveSummaryResponseList instances are equal
        /// </summary>
        /// <param name="input">Instance of CompetitiveSummaryResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompetitiveSummaryResponseList input)
        {
            if (input == null)
                return false;
