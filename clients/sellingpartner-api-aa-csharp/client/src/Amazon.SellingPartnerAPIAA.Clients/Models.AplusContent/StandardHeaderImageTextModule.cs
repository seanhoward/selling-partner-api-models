...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.AplusContent
{
    ...
    /// </summary>
    [DataContract]
    public partial class StandardHeaderImageTextModule : IEquatable<StandardHeaderImageTextModule>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as StandardHeaderImageTextModule);
        }

        /// <summary>
        /// Returns true if StandardHeaderImageTextModule instances are equal
        /// </summary>
        /// <param name="input">Instance of StandardHeaderImageTextModule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StandardHeaderImageTextModule input)
        {
            if (input == null)
                return false;
