...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Solicitations
{
    ...
    public partial class GetSolicitationActionsForOrderResponse : IEquatable<GetSolicitationActionsForOrderResponse>, IValidatableObject
    {
        ...
        public GetSolicitationActionsForOrderResponse(GetSolicitationActionsForOrderResponseLinks links = default, GetSolicitationActionsForOrderResponseEmbedded embedded = default, ErrorList errors = default)
        {
            this.Links = links;
