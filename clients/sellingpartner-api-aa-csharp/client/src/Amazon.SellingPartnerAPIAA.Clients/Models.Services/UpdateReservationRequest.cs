...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Services
{
    ...
    public partial class UpdateReservationRequest : IEquatable<UpdateReservationRequest>, IValidatableObject
    {
        ...
        public UpdateReservationRequest(string resourceId = default, Reservation reservation = default)
        {
            ...
            if (resourceId == null)
            {
                throw new InvalidDataException("resourceId is a required property for UpdateReservationRequest and cannot be null");
            }
            else
            {
            ...
            if (reservation == null)
            {
                throw new InvalidDataException("reservation is a required property for UpdateReservationRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UpdateReservationRequest);
        }

        /// <summary>
        /// Returns true if UpdateReservationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateReservationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateReservationRequest input)
        {
            if (input == null)
                return false;
