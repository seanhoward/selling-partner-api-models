...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Services
{
    ...
    public partial class UpdateReservationRecord :  IEquatable<UpdateReservationRecord>, IValidatableObject
    {
        ...
        public UpdateReservationRecord(Reservation reservation = default(Reservation), WarningList warnings = default(WarningList), ErrorList errors = default(ErrorList))
        {
