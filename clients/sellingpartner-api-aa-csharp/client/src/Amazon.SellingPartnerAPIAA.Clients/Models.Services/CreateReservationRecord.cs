...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Services
{
    ...
    public partial class CreateReservationRecord : IEquatable<CreateReservationRecord>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateReservationRecord);
        }

        /// <summary>
        /// Returns true if CreateReservationRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReservationRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReservationRecord input)
        {
            if (input == null)
                return false;
