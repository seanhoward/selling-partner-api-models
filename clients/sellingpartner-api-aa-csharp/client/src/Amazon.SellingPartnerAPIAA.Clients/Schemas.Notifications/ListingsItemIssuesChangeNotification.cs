...
namespace Amazon.SellingPartnerAPIAA.Clients.Schemas.Notifications.ListingsItemIssuesChange
{
    ...
    public partial class ListingsItemIssuesChangeNotification
    {
        /// <summary>
        ...
        public ListingsItemIssuesChangeNotificationNotificationType NotificationType { get; set; }
        ...
        public static ListingsItemIssuesChangeNotification FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingsItemIssuesChangeNotification>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "11.1.0.0 (Newtonsoft.Json v13.0.0.0)")]
    public enum ListingsItemIssuesChangeNotificationNotificationType
    {
