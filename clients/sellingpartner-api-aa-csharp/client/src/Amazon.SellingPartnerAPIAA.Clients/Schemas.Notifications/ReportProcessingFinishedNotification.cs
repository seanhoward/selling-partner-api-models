...
namespace Amazon.SellingPartnerAPIAA.Clients.Schemas.Notifications.ReportProcessingFinished
{
    ...
    public partial class ReportProcessingFinishedNotification
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("reportDocumentId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
