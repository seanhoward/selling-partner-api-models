...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.OrdersV0
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderV0 :  IEquatable<OrderV0>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="paymentExecutionDetail">Information about the sub-payment methods for an order..</param>
        ...
        /// </summary>
        /// <value>Information about the sub-payment methods for an order.</value>
        ...
        {
            return this.Equals(input as OrderV0);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(OrderV0 input)
        {
            if (input == null)
                return false;
