...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.FulfillmentInbound
{
    ...
    public partial class AddressInput :  IEquatable<AddressInput>, IValidatableObject
    {
        ...
        public AddressInput(string addressLine1 = default, string addressLine2 = default, string city = default, string companyName = default, string countryCode = default, string email = default, string name = default, string phoneNumber = default, string postalCode = default, string stateOrProvinceCode = default)
        {
            ...
            {
                throw new InvalidDataException("addressLine1 is a required property for AddressInput and cannot be null");
            }
            else
            {
            ...
            if (city == null)
            {
                throw new InvalidDataException("city is a required property for AddressInput and cannot be null");
            }
            else
            {
                this.City = city;
            ...
            if (countryCode == null)
            {
                throw new InvalidDataException("countryCode is a required property for AddressInput and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AddressInput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for AddressInput and cannot be null");
            }
            else
            {
            ...
            if (postalCode == null)
            {
                throw new InvalidDataException("postalCode is a required property for AddressInput and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Returns true if AddressInput instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressInput to be compared</param>
        /// <returns>Boolean</returns>
