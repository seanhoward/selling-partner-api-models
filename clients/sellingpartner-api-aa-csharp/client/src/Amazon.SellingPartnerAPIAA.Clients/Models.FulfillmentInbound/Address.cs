...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.FulfillmentInbound
{
    ...
    public partial class Address : IEquatable<Address>, IValidatableObject
    {
        ...
        public Address(string addressLine1 = default, string addressLine2 = default, string city = default, string companyName = default, string countryCode = default, string email = default, string name = default, string phoneNumber = default, string postalCode = default, string stateOrProvinceCode = default)
        {
