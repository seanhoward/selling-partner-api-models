...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.VendorDirectFulfillmentSandboxData
{
    ...
    /// </summary>
    [DataContract]
    public partial class TestOrder :  IEquatable<TestOrder>, IValidatableObject
    {
        /// <summary>
        ...
        public TestOrder(string orderId = default)
        {
            ...
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for TestOrder and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TestOrder);
        }

        /// <summary>
        /// Returns true if TestOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of TestOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestOrder input)
        {
            if (input == null)
                return false;
