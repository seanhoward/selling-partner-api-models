...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemPicking :  IEquatable<ItemPicking>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemPicking" /> class.
        /// </summary>
        ...
        public ItemPicking(ItemSubstitutionPreference substitutionPreference = default(ItemSubstitutionPreference))
        {
        ...
        public ItemSubstitutionPreference SubstitutionPreference { get; set; }
        ...
        {
            return this.Equals(input as ItemPicking);
        }

        /// <summary>
        /// Returns true if ItemPicking instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemPicking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemPicking input)
        {
            if (input == null)
                return false;
