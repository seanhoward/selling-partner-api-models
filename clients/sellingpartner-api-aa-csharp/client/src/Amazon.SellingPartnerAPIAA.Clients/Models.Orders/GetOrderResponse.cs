...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Orders
{
    ...
    public partial class GetOrderResponse :  IEquatable<GetOrderResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="GetOrderResponse" /> class.
        /// </summary>
        /// <param name="order">All available information about the requested order. (required).</param>
        public GetOrderResponse(Order order = default(Order))
        {
            // to ensure "order" is required (not null)
            if (order == null)
            {
                throw new InvalidDataException("order is a required property for GetOrderResponse and cannot be null");
            }
            else
            {
                this.Order = order;
        ...
        /// </summary>
        /// <value>All available information about the requested order.</value>
