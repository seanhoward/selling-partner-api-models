...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Orders
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemPointsCost :  IEquatable<ItemPointsCost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemPointsCost" /> class.
        /// </summary>
        /// <param name="pointsGranted">Details of the Amazon Points granted, including count and monetary value..</param>
        public ItemPointsCost(PointsGranted pointsGranted = default(PointsGranted))
        {
        ...
        /// </summary>
        /// <value>Details of the Amazon Points granted, including count and monetary value.</value>
        ...
        {
            return this.Equals(input as ItemPointsCost);
        }

        /// <summary>
        /// Returns true if ItemPointsCost instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemPointsCost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemPointsCost input)
        {
            if (input == null)
                return false;
