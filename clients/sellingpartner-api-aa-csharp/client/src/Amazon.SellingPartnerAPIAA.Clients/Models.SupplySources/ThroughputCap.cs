...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.SupplySources
{
    ...
    /// </summary>
    [DataContract]
    public partial class ThroughputCap : IEquatable<ThroughputCap>, IValidatableObject
    {
        /// <summary>
        ...
        public ThroughputCap(int? value = default, TimeUnit? timeUnit = default)
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as ThroughputCap);
        }

        /// <summary>
        /// Returns true if ThroughputCap instances are equal
        /// </summary>
        /// <param name="input">Instance of ThroughputCap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThroughputCap input)
        {
            if (input == null)
                return false;
