...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.SupplySources
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactDetailsPrimary :  IEquatable<ContactDetailsPrimary>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ContactDetailsPrimary);
        }

        /// <summary>
        /// Returns true if ContactDetailsPrimary instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactDetailsPrimary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactDetailsPrimary input)
        {
            if (input == null)
                return false;
