...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.VendorInvoices
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        public Address(string name = default, string addressLine1 = default, string addressLine2 = default, string addressLine3 = default, string city = default, string county = default, string district = default, string stateOrRegion = default, string postalOrZipCode = default, string countryCode = default, string phone = default)
        {
