...
namespace Amazon.SellingPartnerAPIAA.Clients.Schemas.Feeds.ListingsMessageSchema
{
    ...
    public partial class ListingsFeedMessage
    {
        ...
        public static ListingsFeedMessage FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingsFeedMessage>(data, new Newtonsoft.Json.JsonSerializerSettings());
