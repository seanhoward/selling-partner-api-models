...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.Transfers
{
    ...
    public partial class GetPaymentMethodsResponse :  IEquatable<GetPaymentMethodsResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetPaymentMethodsResponse);
        }

        /// <summary>
        /// Returns true if GetPaymentMethodsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPaymentMethodsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPaymentMethodsResponse input)
        {
            if (input == null)
                return false;
