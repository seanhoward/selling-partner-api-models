...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.VendorOrders
{
    ...
    public partial class PartyIdentification : IEquatable<PartyIdentification>, IValidatableObject
    {
        ...
        /// <param name="taxInfo">Tax registration details of the party..</param>
        public PartyIdentification(string partyId = default, Address address = default, TaxRegistrationDetails taxInfo = default)
        {
