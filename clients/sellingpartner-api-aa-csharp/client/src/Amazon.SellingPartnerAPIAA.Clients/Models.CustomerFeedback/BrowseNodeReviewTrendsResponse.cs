...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.CustomerFeedback
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrowseNodeReviewTrendsResponse : IEquatable<BrowseNodeReviewTrendsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="dateRange">The range of dates during which the reviews were made. (required).</param>
        /// <param name="reviewTrends">Browse Node review trends. (required).</param>
        public BrowseNodeReviewTrendsResponse(string browseNodeId = default, string displayName = default, string marketplaceId = default, string countryCode = default, DateRange dateRange = default, BrowseNodeReviewTrends reviewTrends = default)
        {
            // to ensure "browseNodeId" is required (not null)
            if (browseNodeId == null)
            {
                throw new InvalidDataException("browseNodeId is a required property for BrowseNodeReviewTrendsResponse and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for BrowseNodeReviewTrendsResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("marketplaceId is a required property for BrowseNodeReviewTrendsResponse and cannot be null");
            }
            else
            {
            ...
            if (countryCode == null)
            {
                throw new InvalidDataException("countryCode is a required property for BrowseNodeReviewTrendsResponse and cannot be null");
            }
            else
            {
            ...
            if (dateRange == null)
            {
                throw new InvalidDataException("dateRange is a required property for BrowseNodeReviewTrendsResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("reviewTrends is a required property for BrowseNodeReviewTrendsResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The range of dates during which the reviews were made.</value>
        ...
        /// </summary>
        /// <value>Browse Node review trends.</value>
        ...
        {
            return this.Equals(input as BrowseNodeReviewTrendsResponse);
        }

        /// <summary>
        /// Returns true if BrowseNodeReviewTrendsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BrowseNodeReviewTrendsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrowseNodeReviewTrendsResponse input)
        {
            if (input == null)
                return false;
