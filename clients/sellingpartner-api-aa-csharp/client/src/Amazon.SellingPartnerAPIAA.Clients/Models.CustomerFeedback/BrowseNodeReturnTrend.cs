...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.CustomerFeedback
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrowseNodeReturnTrend : IEquatable<BrowseNodeReturnTrend>, IValidatableObject
    {
        /// <summary>
        ...
        public BrowseNodeReturnTrend(string topic = default, List<BrowseNodeReturnTrendPoint> trendMetrics = default)
        {
            // to ensure "topic" is required (not null)
            if (topic == null)
            {
                throw new InvalidDataException("topic is a required property for BrowseNodeReturnTrend and cannot be null");
            }
            else
            {
                this.Topic = topic;
            ...
            {
                throw new InvalidDataException("trendMetrics is a required property for BrowseNodeReturnTrend and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BrowseNodeReturnTrend);
        }

        /// <summary>
        /// Returns true if BrowseNodeReturnTrend instances are equal
        /// </summary>
        /// <param name="input">Instance of BrowseNodeReturnTrend to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrowseNodeReturnTrend input)
        {
            if (input == null)
                return false;
