...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.CustomerFeedback
{
    ...
    /// </summary>
    [DataContract]
    public partial class BrowseNodeReviewTopicsResponse : IEquatable<BrowseNodeReviewTopicsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="topics">The most positive and most negative topics for all items in the browse node. (required).</param>
        public BrowseNodeReviewTopicsResponse(string browseNodeId = default, string displayName = default, string marketplaceId = default, string countryCode = default, DateRange dateRange = default, BrowseNodeReviewTopics topics = default)
        {
            // to ensure "browseNodeId" is required (not null)
            if (browseNodeId == null)
            {
                throw new InvalidDataException("browseNodeId is a required property for BrowseNodeReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for BrowseNodeReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("marketplaceId is a required property for BrowseNodeReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (countryCode == null)
            {
                throw new InvalidDataException("countryCode is a required property for BrowseNodeReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (dateRange == null)
            {
                throw new InvalidDataException("dateRange is a required property for BrowseNodeReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (topics == null)
            {
                throw new InvalidDataException("topics is a required property for BrowseNodeReviewTopicsResponse and cannot be null");
            }
            else
            {
                this.Topics = topics;
        ...
        /// </summary>
        /// <value>The most positive and most negative topics for all items in the browse node.</value>
        ...
        {
            return this.Equals(input as BrowseNodeReviewTopicsResponse);
        }

        /// <summary>
        /// Returns true if BrowseNodeReviewTopicsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BrowseNodeReviewTopicsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrowseNodeReviewTopicsResponse input)
        {
            if (input == null)
                return false;
