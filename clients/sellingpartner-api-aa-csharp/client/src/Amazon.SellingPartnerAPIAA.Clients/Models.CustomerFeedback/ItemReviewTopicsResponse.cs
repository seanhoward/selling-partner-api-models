...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.CustomerFeedback
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemReviewTopicsResponse : IEquatable<ItemReviewTopicsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="dateRange">The date range of the item review topics. (required).</param>
        /// <param name="topics">The item review topics for the requested ASIN. (required).</param>
        public ItemReviewTopicsResponse(string asin = default, string itemName = default, string marketplaceId = default, string countryCode = default, DateRange dateRange = default, ItemReviewTopics topics = default)
        {
            // to ensure "asin" is required (not null)
            if (asin == null)
            {
                throw new InvalidDataException("asin is a required property for ItemReviewTopicsResponse and cannot be null");
            }
            else
            {
                this.Asin = asin;
            ...
            if (itemName == null)
            {
                throw new InvalidDataException("itemName is a required property for ItemReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("marketplaceId is a required property for ItemReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (countryCode == null)
            {
                throw new InvalidDataException("countryCode is a required property for ItemReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (dateRange == null)
            {
                throw new InvalidDataException("dateRange is a required property for ItemReviewTopicsResponse and cannot be null");
            }
            else
            {
            ...
            if (topics == null)
            {
                throw new InvalidDataException("topics is a required property for ItemReviewTopicsResponse and cannot be null");
            }
            else
            {
                this.Topics = topics;
        ...
        /// </summary>
        /// <value>The date range of the item review topics.</value>
        ...
        /// </summary>
        /// <value>The item review topics for the requested ASIN.</value>
        ...
        {
            return this.Equals(input as ItemReviewTopicsResponse);
        }

        /// <summary>
        /// Returns true if ItemReviewTopicsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemReviewTopicsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemReviewTopicsResponse input)
        {
            if (input == null)
                return false;
