...
namespace Amazon.SellingPartnerAPIAA.Clients.Models.VendorShipments
{
    ...
    public partial class PurchaseOrderItems :  IEquatable<PurchaseOrderItems>, IValidatableObject
    {
        ...
        public PurchaseOrderItems(string itemSequenceNumber = default, string buyerProductIdentifier = default, string vendorProductIdentifier = default, ItemQuantity shippedQuantity = default, Money maximumRetailPrice = default)
        {
        ...
        /// <summary>
        /// Returns true if PurchaseOrderItems instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseOrderItems to be compared</param>
        /// <returns>Boolean</returns>
