# Amazon.SellingPartnerAPIAA.Clients.API.AutomotiveApi
...
namespace Example
{
    public class GetVehiclesExample
    {
        public void main()
        {
            var apiInstance = new AutomotiveApi();
            ...
            {
                Debug.Print("Exception when calling AutomotiveApi.GetVehicles: " + e.Message );
            }
        }
    }
}
